...
const reasons: Reason[] = [
  {
    ...
    icon: Star,
    front: "Reason #1",
    back: "Your ambition inspires me every single day to be a better person.",
  ...
  },
  {
    ...
    icon: Heart,
    front: "Reason #2",
    back: "You have the biggest, warmest heart of anyone I know.",
  ...
  },
  {
    ...
    icon: Cloud,
    front: "Reason #3",
    back: "Even on cloudy days, you somehow manage to find the silver lining.",
