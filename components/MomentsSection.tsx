...
const moments: Moment[] = [
  {
    id: '1',
    title: 'Your Smile',
    description: 'It honestly lights up the entire room. Never stop smiling.',
    icon: 'sun'
  },
  {
    id: '2',
    title: 'Your Kindness',
    description: 'The way you care about others is so rare and beautiful.',
    icon: 'heart'
  },
  {
    id: '3',
    title: 'Your Laugh',
    description: 'My favorite sound in the whole world. It’s contagious!',
    icon: 'music'
  },
  {
    id: '4',
    title: 'Just You',
    description: 'Simply being yourself is your superpower.',
    icon: 'star'
  }
];
